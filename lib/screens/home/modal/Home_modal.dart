...
//
//     final gitaModel = gitaModelFromJson(jsonString);

import 'dart:convert';

List<GitaModel> gitaModelFromJson(String str) => List<GitaModel>.from(json.decode(str).map((x) => GitaModel.fromJson(x)));

String gitaModelToJson(List<GitaModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GitaModel {
  ...
  factory GitaModel.fromJson(Map<String, dynamic> json) => GitaModel(
    id: json["id"],
    name: json["name"],
    slug: json["slug"],
